LineChart7 = React.createClass({
	...
	var areaOzone= d3.svg.area()
		.interpolate(interpolation)
		.x(function(d) { return x(d.year); })
		.y0(function(d) { return y(d.ozoneLower); })
		.y1(function(d) { return y(d.ozoneUpper); });
...
//Legend
	...
	function type2(d) {
	    d.year = parseInt(d.year);
	    d.orbitalChanges = kToC(+d.ozone) - kToC(287.50310744057606);
	    d.ozoneUpper = env + d.orbitalChanges;
	    d.ozoneLower = - env + d.orbitalChanges;
