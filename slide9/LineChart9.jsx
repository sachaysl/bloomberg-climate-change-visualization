LineChart9 = React.createClass({
	...
	var areaGreenhouse= d3.svg.area()
		.interpolate(interpolation)
		.x(function(d) { return x(d.year); })
		.y0(function(d) { return y(d.greenhouseLower); })
		.y1(function(d) { return y(d.greenhouseUpper); });
...
//Legend
	...
	function type2(d) {
	    d.year = parseInt(d.year);
	    d.orbitalChanges = kToC(+d.greenhouseGases) - kToC(287.50310744057606);
	    d.greenhouseUpper = env + d.orbitalChanges;
	    d.greenhouseLower = - env + d.orbitalChanges;
